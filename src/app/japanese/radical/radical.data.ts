...
const RADICALS: Radical[] = [
  ...
  { characters: '𡗗', meanings: ['spring'], type: CharacterType.RADICAL },
  {
    characters: '介',
    meanings: ['jammed in'],
    type: CharacterType.RADICAL,
  ...
  { characters: '並', meanings: ['line up'], type: CharacterType.RADICAL },
  ...
  { characters: '監', meanings: ['oversee'], type: CharacterType.RADICAL },
  ...
  { characters: '郎', meanings: ['guy'], type: CharacterType.RADICAL },
  { characters: '离', meanings: ['rocket'], type: CharacterType.RADICAL },
