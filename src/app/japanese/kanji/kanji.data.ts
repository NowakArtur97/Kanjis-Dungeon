...
const KANJI: Kanji[] = [
  ...
  {
    characters: '細',
    meanings: ['thin', 'narrow', 'fine', 'detailed'],
    onyomi: ['さい'],
    kunyomi: ['ほそ', 'こま'],
    type: CharacterType.KANJI,
  },
  ...
  {
    characters: '庫',
    meanings: ['storage', 'storehouse', 'warehouse'],
    onyomi: ['こ'],
    kunyomi: ['くら'],
    type: CharacterType.KANJI,
  },
  ...
  {
    characters: '督',
    meanings: ['director', 'supervise'],
    onyomi: ['とく'],
    type: CharacterType.KANJI,
  },
  {
    characters: '寄',
    meanings: ['draw near', 'stop by', 'send'],
    onyomi: ['き'],
    kunyomi: ['よ'],
    type: CharacterType.KANJI,
  },
  ...
  {
    characters: '鑑',
    meanings: ['model', 'take into account'],
    onyomi: ['かん'],
    kunyomi: ['かんが', 'かがみ'],
    type: CharacterType.KANJI,
  },
  ...
  // Focuses on being pregnant, often used to refer to the pregnant woman herself
  {
    characters: '妊',
    meanings: ['pregnant'],
    onyomi: ['にん'],
  ...
  // Specifically represents the act of being pregnant or with child, generally used in combination with 妊
  // 妊婦 (Ninpu): Pregnant woman (person-focused).
  // 妊娠 (Ninshin): Pregnancy/To be pregnant (condition-focused).
  {
    characters: '娠',
    meanings: ['pregnant'],
    onyomi: ['しん'],
